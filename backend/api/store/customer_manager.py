...
from schemas.store import CustomerManagerRead, CustomerManagerCreate, CustomerManagerUpdate
...
async def get_user_filter_list(pagination: Pagination = Depends(Pagination),
    ...
    return await CustomerManagerRepository(session).get_user_filter_list(pagination.skip,
                                                                         pagination.limit,
                                                                         filters.phone,
                                                                         filters.email)
